...
const StockMarketAnalyticsDetails = () => {
  ...
  const modules = [
    ...
    "Basic Excel",
    "Advance Excel",
    "First Dataset for Analysis in Excel",
    "Financial Statements and Ratios",
    "Understanding Stock Market Fundamental Data",
    "Stock Market Data Analytics in Excel",
    "Basic PowerBI",
    "First Dataset Analysis in PowerBI",
    "Stock Market Data Analytics in PowerBI Next Steps and Projects"
  ];
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Master stock market data analytics using Excel and PowerBI. Learn financial statements analysis, fundamental data interpretation, and visualization.
              </p>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700">Excel mastery from basic to advanced</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0 mt-1">
                    <div className="w-2 h-2 rounded-full bg-orange-600"></div>
                  </div>
                  <span className="text-gray-700">PowerBI for data visualization</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0 mt-1">
                    <div className="w-2 h-2 rounded-full bg-orange-600"></div>
                  </div>
                  <span className="text-gray-700">Stock market fundamental data analysis</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0 mt-1">
                    <div className="w-2 h-2 rounded-full bg-orange-600"></div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Excel Analytics</h3>
              <p className="text-gray-600">
                Master Excel for financial data analysis and stock market analytics
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">PowerBI Visualization</h3>
              <p className="text-gray-600">
                Create powerful visualizations and dashboards with PowerBI
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <p className="text-gray-600">
                Analyze financial statements, ratios, and stock market data
              </p>
            </div>
          </div>
        </div>
...
export default StockMarketAnalyticsDetails;
