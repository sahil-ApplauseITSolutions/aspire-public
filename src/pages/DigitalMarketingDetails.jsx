...
const DigitalMarketingDetails = () => {
  ...
  const modules = [
    "Intro To Marketing & Digital Marketing",
    "Website Designing",
    "Identifying your audience and brand image",
    "Introduction To SEO & Google SERP",
    "Types of SEO Strategy & SEO Practices",
    "Introduction To SEM, SEO V/S SEM",
    "Types of campaigns and their importance: Google Ads Auction, Bidding Strategies",
    "Intro To SMM & User Behavior",
    "Types Of Social Media marketing",
    "Online Reputation Management",
    "Setting Up Meta Ads Campaign",
    "Intro to Heatmaps, Clickmaps, Scroll Depth Next Steps & Projects"
  ];
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Master comprehensive digital marketing strategies including SEO, SEM, social media marketing, and online reputation management for business growth.
              </p>
              ...
              <div className="flex flex-wrap gap-6 mb-8">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-gray-700">12 Modules</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700">Complete SEO and SEM strategies</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0 mt-1">
                    <div className="w-2 h-2 rounded-full bg-orange-600"></div>
                  </div>
                  <span className="text-gray-700">Social media marketing and Meta Ads campaigns</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0 mt-1">
                    <div className="w-2 h-2 rounded-full bg-orange-600"></div>
                  </div>
                  <span className="text-gray-700">Website design and brand image development</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0 mt-1">
                    <div className="w-2 h-2 rounded-full bg-orange-600"></div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">SEO & SEM</h3>
              <p className="text-gray-600">
                Master search engine optimization and marketing strategies for better visibility
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <p className="text-gray-600">
                Learn social media strategies, Meta Ads campaigns, and user behavior analysis
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <p className="text-gray-600">
                Understand heatmaps, clickmaps, and online reputation management techniques
              </p>
            </div>
          </div>
        </div>
