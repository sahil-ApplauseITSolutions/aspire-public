...
const DigitalMarketingSEOGoogleAdsDetails = () => {
  ...
  const modules = [
    "Google Algorithms & How Google ranks your website",
    "On - Page Optimization",
    "Off - Page Optimization",
    "Best & worst Practices of SEO",
    "SEO Audit & Strategy",
    "Google Adwords - Theory",
    "Setting and optimizing Google campaigns",
    "LP Optimization",
    "Media Planning Next Steps and Projects"
  ];
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Specialized training in SEO optimization and Google Ads campaigns. Master on-page and off-page optimization, Google algorithms, and campaign management.
              </p>
              ...
              <div className="flex flex-wrap gap-6 mb-8">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-gray-700">9 Modules</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700">Deep dive into Google algorithms and ranking factors</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0 mt-1">
                    <div className="w-2 h-2 rounded-full bg-orange-600"></div>
                  </div>
                  <span className="text-gray-700">Complete on-page and off-page optimization</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0 mt-1">
                    <div className="w-2 h-2 rounded-full bg-orange-600"></div>
                  </div>
                  <span className="text-gray-700">Google Ads campaign setup and optimization</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0 mt-1">
                    <div className="w-2 h-2 rounded-full bg-orange-600"></div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">SEO Mastery</h3>
              <p className="text-gray-600">
                Master Google algorithms, on-page and off-page optimization techniques
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <p className="text-gray-600">
                Learn Google Adwords theory, campaign setup, and optimization strategies
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <p className="text-gray-600">
                Develop SEO audit skills, landing page optimization, and media planning
              </p>
            </div>
          </div>
        </div>
...
export default DigitalMarketingSEOGoogleAdsDetails;
