...
const DigitalMarketingSocialMediaDetails = () => {
  ...
  const modules = [
    "Introduction",
    "Social Media Strategy for a brand",
    "Meta",
    "LinkedIn",
    "YouTube",
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Specialized training in social media marketing across Meta, LinkedIn, and YouTube. Master content creation, brand strategy, and online reputation management.
              </p>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700">Multi-platform social media strategies</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0 mt-1">
                    <div className="w-2 h-2 rounded-full bg-orange-600"></div>
                  </div>
                  <span className="text-gray-700">Content creation and marketing strategies</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0 mt-1">
                    <div className="w-2 h-2 rounded-full bg-orange-600"></div>
                  </div>
                  <span className="text-gray-700">Online reputation management and chatbots</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0 mt-1">
                    <div className="w-2 h-2 rounded-full bg-orange-600"></div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Platform Mastery</h3>
              <p className="text-gray-600">
                Master social media marketing on Meta, LinkedIn, and YouTube platforms
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <p className="text-gray-600">
                Learn to create powerful, shareable content and develop content marketing strategies
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <p className="text-gray-600">
                Develop social media strategies, manage online reputation, and optimize campaigns
              </p>
            </div>
          </div>
        </div>
...
export default DigitalMarketingSocialMediaDetails;
