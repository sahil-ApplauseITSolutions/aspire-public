...
const PythonForFinanceDetails = () => {
  ...
  const modules = [
    ...
    "Basic Python",
    "Advance Python",
    "First Dataset for Analysis in Python",
    "Numpy, Pandas, Matplotlib for Data Analysis",
    "Finance functions in python",
    "Understanding Financial Data",
    "Financial Data Analysis in Python",
    "Data Visualization Next Steps and Projects"
  ];
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Learn Python programming for financial data analysis. Master Numpy, Pandas, Matplotlib, and finance-specific functions for data-driven insights.
              </p>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700">Python programming from basics to advanced</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0 mt-1">
                    <div className="w-2 h-2 rounded-full bg-orange-600"></div>
                  </div>
                  <span className="text-gray-700">Data analysis with Numpy, Pandas, Matplotlib</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0 mt-1">
                    <div className="w-2 h-2 rounded-full bg-orange-600"></div>
                  </div>
                  <span className="text-gray-700">Finance-specific functions and applications</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0 mt-1">
                    <div className="w-2 h-2 rounded-full bg-orange-600"></div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Data Analysis Libraries</h3>
              <p className="text-gray-600">
                Learn Numpy, Pandas, and Matplotlib for powerful data analysis
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <p className="text-gray-600">
                Apply Python to financial data analysis and visualization
              </p>
            </div>
          </div>
        </div>
...
export default PythonForFinanceDetails;
