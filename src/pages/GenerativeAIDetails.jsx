...
const GenerativeAIDetails = () => {
  ...
  const modules = [
    "Intro To Generative AI, Evolution, Future",
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Explore Generative AI applications across finance, accounting, marketing, analytics, and operations. Learn the evolution and future of AI technology.
              </p>
              ...
              <div className="flex flex-wrap gap-6 mb-8">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-gray-700">6 Modules</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700">Generative AI fundamentals and evolution</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0 mt-1">
                    <div className="w-2 h-2 rounded-full bg-orange-600"></div>
                  </div>
                  <span className="text-gray-700">AI applications in finance and accounting</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0 mt-1">
                    <div className="w-2 h-2 rounded-full bg-orange-600"></div>
                  </div>
                  <span className="text-gray-700">Marketing, analytics, and operations use cases</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0 mt-1">
                    <div className="w-2 h-2 rounded-full bg-orange-600"></div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">AI Fundamentals</h3>
              <p className="text-gray-600">
                Understand Generative AI evolution, capabilities, and future trends
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Business Applications</h3>
              <p className="text-gray-600">
                Apply AI in finance, accounting, marketing, and analytics
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <p className="text-gray-600">
                Leverage Generative AI for operational efficiency and innovation
              </p>
            </div>
          </div>
        </div>
