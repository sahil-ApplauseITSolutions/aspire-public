...
const LogicCompetitiveExamsDetails = () => {
  ...
  const modules = [
    ...
    "Blood Relations",
    "Arrangements",
    "Ordering, Sequencing and Comparisons",
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Master logical reasoning for competitive exams. Learn analytical, verbal, and non-verbal reasoning with practical problem-solving techniques.
              </p>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700">Comprehensive logical reasoning training</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0 mt-1">
                    <div className="w-2 h-2 rounded-full bg-orange-600"></div>
                  </div>
                  <span className="text-gray-700">Analytical and verbal reasoning skills</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0 mt-1">
                    <div className="w-2 h-2 rounded-full bg-orange-600"></div>
                  </div>
                  <span className="text-gray-700">Non-verbal and spatial reasoning</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0 mt-1">
                    <div className="w-2 h-2 rounded-full bg-orange-600"></div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Analytical Reasoning</h3>
              <p className="text-gray-600">
                Master arrangements, sequences, and decision-making problems
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Verbal Reasoning</h3>
              <p className="text-gray-600">
                Learn blood relations, direction sense, and logical deductions
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Non-Verbal Skills</h3>
              <p className="text-gray-600">
                Develop spatial reasoning with cubes, cuboids, and visual patterns
              </p>
            </div>
          </div>
        </div>
...
export default LogicCompetitiveExamsDetails;
