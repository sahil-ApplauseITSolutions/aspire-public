...
const InvestmentBankingOperationsDetails = () => {
  ...
  const modules = [
    ...
    "Risk Management in IB Operations",
    "Regulations & Compliance",
    "Derivatives Operations (Basic)",
    "Trade Reconciliation",
    "Middle Office Functions",
    "Market Data & Systems Overview",
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Learn global banking operations and investment banking fundamentals. Master trade life cycle, risk management, and middle office functions.
              </p>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700">Complete trade life cycle and operations</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0 mt-1">
                    <div className="w-2 h-2 rounded-full bg-orange-600"></div>
                  </div>
                  <span className="text-gray-700">Equity, fixed income, and derivatives products</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0 mt-1">
                    <div className="w-2 h-2 rounded-full bg-orange-600"></div>
                  </div>
                  <span className="text-gray-700">Risk management and compliance</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0 mt-1">
                    <div className="w-2 h-2 rounded-full bg-orange-600"></div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">IB Operations</h3>
              <p className="text-gray-600">
                Master investment banking operations, trade life cycle, and reconciliation
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Financial Products</h3>
              <p className="text-gray-600">
                Learn equity, fixed income, and derivatives products and operations
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Risk & Compliance</h3>
              <p className="text-gray-600">
                Understand risk management, regulations, and middle office functions
              </p>
            </div>
          </div>
        </div>
...
export default InvestmentBankingOperationsDetails;
