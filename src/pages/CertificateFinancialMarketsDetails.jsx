...
const CertificateFinancialMarketsDetails = () => {
  ...
  const modules = [
    ...
    "Securities: Types, features, concepts of asset allocation and investing",
    "Primary markets",
    "Secondary markets",
    "Mutual Funds",
    "Derivative Markets",
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Comprehensive understanding of securities markets, primary and secondary markets, mutual funds, and derivative markets with practical applications.
              </p>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700">Complete securities markets understanding</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0 mt-1">
                    <div className="w-2 h-2 rounded-full bg-orange-600"></div>
                  </div>
                  <span className="text-gray-700">Primary and secondary markets operations</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0 mt-1">
                    <div className="w-2 h-2 rounded-full bg-orange-600"></div>
                  </div>
                  <span className="text-gray-700">Mutual funds and derivative markets</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0 mt-1">
                    <div className="w-2 h-2 rounded-full bg-orange-600"></div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <p className="text-gray-600">
                Master securities types, features, and asset allocation concepts
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Market Operations</h3>
              <p className="text-gray-600">
                Learn primary and secondary market operations and mutual funds
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <p className="text-gray-600">
                Apply concepts through practical applications and real-world projects
              </p>
            </div>
          </div>
        </div>
...
export default CertificateFinancialMarketsDetails;
