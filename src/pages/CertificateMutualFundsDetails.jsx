...
const CertificateMutualFundsDetails = () => {
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Comprehensive training in mutual fund operations, distribution, and management. Learn legal frameworks, NAV calculations, taxation, and scheme selection.
              </p>
              ...
              <div className="flex flex-wrap gap-6 mb-8">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-gray-700">14 Modules</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700">Complete mutual fund operations and structure</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0 mt-1">
                    <div className="w-2 h-2 rounded-full bg-orange-600"></div>
                  </div>
                  <span className="text-gray-700">Legal and regulatory framework in India</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0 mt-1">
                    <div className="w-2 h-2 rounded-full bg-orange-600"></div>
                  </div>
                  <span className="text-gray-700">Fund distribution and channel management</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0 mt-1">
                    <div className="w-2 h-2 rounded-full bg-orange-600"></div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Mutual Fund Operations</h3>
              <p className="text-gray-600">
                Understand mutual fund concepts, legal structures, and operational frameworks in India
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Distribution & Management</h3>
              <p className="text-gray-600">
                Master fund distribution practices, NAV calculations, and investor services
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Scheme Selection</h3>
              <p className="text-gray-600">
                Learn scheme performance evaluation, risk assessment, and selection strategies
              </p>
            </div>
          </div>
        </div>
...
export default CertificateMutualFundsDetails;
