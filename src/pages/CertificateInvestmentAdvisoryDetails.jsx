...
const CertificateInvestmentAdvisoryDetails = () => {
  ...
  const modules = [
    ...
    "Evaluating financial position of clients",
    "Debt management and loans",
    "Indian financial markets",
    "Investing in stocks, bonds, derivatives",
    "Mutual funds",
    "Portfolio manager",
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
                Certificate in Investment Advisory
              </h1>
              <p className="text-lg text-gray-600 mb-8">
                Become a professional investment advisor with comprehensive training in financial planning, portfolio management, and investment strategies across asset classes.
              </p>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700">Personal financial planning and client evaluation</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0 mt-1">
                    <div className="w-2 h-2 rounded-full bg-orange-600"></div>
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700">Portfolio construction and performance measurement</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0 mt-1">
                    <div className="w-2 h-2 rounded-full bg-orange-600"></div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <p className="text-gray-600">
                Master personal financial planning and client financial position evaluation
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Investment Strategies</h3>
              <p className="text-gray-600">
                Learn investing across stocks, bonds, derivatives, mutual funds, and alternative investments
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <p className="text-gray-600">
                Develop portfolio construction and performance measurement expertise
              </p>
            </div>
          </div>
        </div>
...
export default CertificateInvestmentAdvisoryDetails;
