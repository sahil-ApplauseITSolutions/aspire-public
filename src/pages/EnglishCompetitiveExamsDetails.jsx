...
const EnglishCompetitiveExamsDetails = () => {
  ...
  const modules = [
    "Introduction to CAT Verbal Ability",
    "Vocabulary Building",
    ...
    "Paragraph Completion/Last Sentence of Paragraph",
    "Phrasal Verbs",
    "Irrelevant statement questions",
    "Critical Reasoning Basics",
    "Syllogism",
    "Verbal Reasoning Based on Binary Logic Logical Deductions"
  ];
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Master verbal ability for competitive exams. Learn vocabulary, sentence correction, paragraph jumbles, critical reasoning, and verbal reasoning.
              </p>
              ...
              <div className="flex flex-wrap gap-6 mb-8">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-gray-700">13 Modules</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700">Comprehensive CAT verbal ability preparation</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0 mt-1">
                    <div className="w-2 h-2 rounded-full bg-orange-600"></div>
                  </div>
                  <span className="text-gray-700">Vocabulary building and sentence correction</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0 mt-1">
                    <div className="w-2 h-2 rounded-full bg-orange-600"></div>
                  </div>
                  <span className="text-gray-700">Critical reasoning and verbal logic</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-orange-100 flex items-center justify-center flex-shrink-0 mt-1">
                    <div className="w-2 h-2 rounded-full bg-orange-600"></div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Verbal Ability</h3>
              <p className="text-gray-600">
                Master vocabulary, sentence correction, and paragraph comprehension
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Critical Reasoning</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Exam Strategy</h3>
              <p className="text-gray-600">
                Learn effective strategies for competitive exam success
              </p>
            </div>
          </div>
        </div>
...
export default EnglishCompetitiveExamsDetails;
